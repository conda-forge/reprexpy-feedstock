...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/reprexpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6552&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/reprexpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `reprexpy` can be installed with:

```
conda install reprexpy
```

It is possible to list all of the versions of `reprexpy` available on your platform with:
